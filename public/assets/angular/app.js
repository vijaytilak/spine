...
monarchApp.constant('WEB_URL', 'http://localhost/spine/public/');
monarchApp.constant('API_URL', 'http://localhost/spine/public/api/');

monarchApp.run(function ($rootScope) {
...
monarchApp.controller('mainController', function ($scope) {
});

monarchApp.controller('indexController', function ($scope) {
});

monarchApp.controller('advanced-datatablesController', function ($scope, $rootScope) {
